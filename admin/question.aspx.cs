        ...
        using (SqlConnection con = new SqlConnection(s))
        {
            ...
            try
            {
                ...
                if (i > 0)
                {
                    ...
                    // Response.Write() will not execute after Redirect
                }
                else
                {
                    panel_examquestion_warning.Visible = true;
            ...
            {
                panel_examquestion_warning.Visible = true;
                lbl_examquestionwarning.Text = "An error occurred: " + ex.Message + "<br />" + ex.StackTrace;
            }

            //catch (Exception ex)
            //{
            //    panel_examquestion_warning.Visible = true;
            //    lbl_examquestionwarning.Text = "Something went wrong. Please try after sometime later</br> Contact your developer for this problem" + ex.Message;
            //}
        }
    }
